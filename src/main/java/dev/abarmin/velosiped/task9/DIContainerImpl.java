...
public class DIContainerImpl implements DIContainer {
    ...
    @Override
    public void init() {
        String packageName = "dev.abarmin.velosiped.task9";
    ...
    private void collectControllerRoutings(Class aClass) throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
        Object newInstance = createInstance(aClass);
